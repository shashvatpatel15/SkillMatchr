      ...
      <AnimatePresence>
        {(selectedCandidate || detailLoading) && (
          <motion.div
            ...
            exit={{ opacity: 0 }}
            onClick={closeModal}
            className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 md:p-8 bg-slate-900/60 backdrop-blur-md"
          >
            <motion.div
              key="detail-modal"
            ...
            >
              {detailLoading ? (
                ...
                <>
                  ...
                  {/* Scrollable Body */}
                  <div className="flex-1 overflow-y-auto min-h-0 p-6 md:p-8 bg-slate-50">
